...
public class JPAMemoryMessageWithAttachmentMapperTest extends MessageWithAttachmentMapperTest {
    ...
    @Override
    protected MapperProvider createMapperProvider() { return new JPAMapperProvider(JPA_TEST_CLUSTER); }
